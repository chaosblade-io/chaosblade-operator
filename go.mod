...
require (
	github.com/chaosblade-io/chaosblade-exec-docker v0.5.1-0.20200427074239-509ea92096f1
	github.com/chaosblade-io/chaosblade-exec-os v0.5.1-0.20200427070718-1dac8677bcab
