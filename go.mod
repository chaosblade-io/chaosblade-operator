...
require (
	github.com/chaosblade-io/chaosblade-exec-cri v1.8.1-0.20251022020314-fc16e67d2ca4
	github.com/chaosblade-io/chaosblade-exec-os v1.8.1-0.20251022020536-09941cedd263
